<template>
  <el-container class="AddOrder">
    <el-header>
      <div class="ty-el-header"><el-col :span="24"><i class="el-icon-date"></i> 当前订单状态：已付款</el-col></div>
    </el-header>
    <el-main>
      ...
      <div class="ty-listone">
        <div class="ty-el-main"><el-col :span="12" ><i class="el-icon-date"></i>预约人信息</el-col></div>
        ...
        <div class="el-el-main-input">
          <el-form>
            <el-form-item label="备注：">
              <el-input placeholder="备注信息"></el-input>
            </el-form-item>
          </el-form>
        </div>
      </div>
