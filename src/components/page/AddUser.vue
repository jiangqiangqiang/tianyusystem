      ...
      <div class="ty-el-main-list1">
        ...
        <div class="ty-content">
          ...
          <div class="ty-content-div-list">
            <span>  &#12288&#12288昵称：</span><el-input v-model="nickName" placeholder="*必填请输入"></el-input>
            <span>  &#12288&#12288手机号码：</span><el-input v-model="mobile" placeholder="*必填请输入"></el-input>
          </div>
          <div class="ty-content-div-list">
            <span>  &#12288&#12288密码：</span><el-input v-model="pwd" placeholder="必填请输入"></el-input>
          </div>
          ...
          <div class="ty-content-div-list">
            <span>  &#12288&#12288姓名：</span><el-input v-model="name" placeholder="*必填请输入"></el-input>
          ...
          <div class="ty-content-div-list"  :model="form">
            <span>  &#12288&#12288年龄：</span><el-input v-model="age" placeholder="*必填请输入"></el-input>
