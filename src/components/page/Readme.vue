        ...
        <div class="ty-elrow-div1">
          ...
          <el-col :span="6">
            <div class="grid-content">
              <div class="ty-grid-content-div1" @click="pathToNext9" style="cursor: pointer"><span>待付款订单</span><span>(<p>{{noPayCount}}</p>)</span>
              </div>
              <div class="ty-grid-content-div1" @click="pathToNext9" style="cursor: pointer"><span>已付款订单</span><span>(<p>{{paiedCount}}</p>)</span>
              </div>
            </div>
          </el-col>
          <el-col :span="6">
