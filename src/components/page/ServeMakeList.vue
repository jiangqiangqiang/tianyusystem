    ...
    <el-header style="height: 100%">
      <el-row >
        <div class="ty-header-list1">
          ...
          <el-col :span="2" :offset="3"><div class="grid-content bg-purple ty-catalogue-list1" style="cursor: pointer" @click="getServeMakeList('')">
            <span>全部<span></span></span>
          </div></el-col>
          <el-col :span="2"><div class="grid-content bg-purple ty-catalogue-list1" style="cursor: pointer" @click="getServeMakeList('0')">
            <span>待处理<span></span></span>
          </div></el-col>
          <el-col :span="2"><div class="grid-content bg-purple ty-catalogue-list1" style="cursor: pointer" @click="getServeMakeList('1')">
      ...
      <el-table :data="tableData" style="width: 100%">
        ...
        <el-table-column label="操作">
          <template slot-scope="scope">
            <el-button size="mini" type="primary" @click="toServeMakeListDetail(scope.row.id,scope.row.status)">查看详情</el-button>
          </template>
        </el-table-column>
      </el-table>
      <!--页数标签-->
