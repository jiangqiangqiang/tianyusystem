<template>
  <el-container class="ServeOrderList">
    ...
    <el-main><!-- 編輯彈窗頁面 catalogueDialog"-->
      ...
      <!--TODO 订单列表-->
      <el-table :data="tableData"  style="width: 100%" highlight-current-row  @current-change="handleSelectionChange">
        ...
        <el-table-column label="操作">
          <template slot-scope="scope">
            <el-button
              size="mini"
              type="primary"
              @click="handlecompile(scope.$index, scope.row.id,scope.row.status)">查看订单</el-button>
          </template>
        </el-table-column>
        <!--删除-->
        <el-table-column label="">
          <template slot-scope="scope">
            <el-button
              size="mini"
              type="primary"
              @click="editformdelet(scope.$index, scope.row.id)">服务跟踪</el-button>
          </template>
        </el-table-column>
      </el-table>
      <!--TODO 页数标签-->
      ...
      <el-dialog
        ...
        <el-form :model="formInline">
          <el-form-item prop="date1" label="时间" :label-width="formLabelWidth">
            <el-date-picker type="date" placeholder="选择日期" v-model="ruleForm.date1" :picker-options="pickerOptions0"  value-format="yyyy-MM-dd"></el-date-picker>
      ...
      <el-dialog
        ...
        <el-form :model="formInline">
          <el-form-item label="时间" :label-width="formLabelWidth">
            <el-date-picker v-model="updataOrder1.time" type="datetime" placeholder="选择日期时间" format="yyyy-MM-dd HH:mm" value-format="yyyy-MM-dd HH:mm">
            </el-date-picker>
          </el-form-item>
      ...
      <el-dialog
        ...
        <el-form :model="formInline">
          <el-form-item label="档案类型" :label-width="formLabelWidth">
            <el-select placeholder="状态" v-model="formInline.region">
              <!--<el-option label="区域一" value="shanghai"></el-option>-->
              <!--<el-option label="区域二" value="beijing"></el-option>-->
              <el-option
        ...
        <span slot="footer" class="dialog-footer">
      <el-button @click="centerDialogVisibleuplodat = false">取 消</el-button>
      ...
      <div class="ty-el-main-list1">
        ...
        <div class="ty-content">
          ...
          <div class="ty-content-div-list">
            <span>  &#12288&#12288昵称：</span><el-input v-model="servicepeople.name"></el-input>
          </div>
          <div class="ty-content-div-list">
            <span>  &#12288&#12288电话：</span><el-input v-model="servicepeople.mobile"></el-input>
          </div>
          <div class="ty-content-div-list">
            <span>  &#12288&#12288身份证号：</span><el-input v-model="servicepeople.idCardNum"></el-input>
          </div>
          <div class="ty-content-div-list">
          ...
          <div class="ty-content-div-list">
            <span>  &#12288&#12288年龄：</span><el-input v-model="servicepeople.age"></el-input>
          </div>
          <!--身份证-->
          <div class="ty-content-div-list">
          ...
          <div class="ty-content-div-list">
            ...
            <el-select placeholder="状态" v-model="specificationId" style="margin-left: 75px;margin-top: 10px">
              <!--<el-option label="区域一" value="shanghai"></el-option>-->
              <!--<el-option label="区域二" value="beijing"></el-option>-->
              <el-option
          ...
          <div class="ty-content-div-list">
            <span>  &#12288&#12288数量：</span><el-input v-model="count" style="margin-left: 15px"></el-input>
          </div>
        </div>
      </div>
      <span slot="footer" class="dialog-footer">
...
//          插入数据进行页面渲染
      ...
      handleSuccess(response, file, fileList){
        ...
        if (response.code == 0){
          ...
          console.log(self.idname,self.idtype ,self.idCardUrl)
        }
      },
      beforeRemove(file, fileList) {
        return this.$confirm(`确定移除 ${ file.name }？`);
      ...
      addnew(){
        ...
        axios({
          ...
          data:{
            ...
            commodityId:self.multipleSelection,
