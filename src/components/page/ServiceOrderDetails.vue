<template>
  ...
  <el-header>
    <div class="ty-el-header">
      ...
      <el-col :span="2"><el-button @click="clientrecord">客户档案</el-button></el-col>
  ...
  <el-main>
    ...
    <!--商品信息-->
    <div class="ty-listone">
      <div class="ty-el-main"><el-col :span="12" ><i class="el-icon-date"></i>商品信息</el-col></div>
      <el-table
        :data="tableData4"
        border
        style="width: 100%; margin-top: 20px">
    ...
    <!--服务信息-->
    <div class="ty-listone">
      <div class="ty-el-main"><el-col :span="12" ><i class="el-icon-date"></i>服务信息</el-col></div>
      <el-table
        :data="tableData2"
        border
...
//        var id=this.params.task_id;
        ...
        var id=this.params.task_id;
        this.$router.push({name:'clientrecord',params:{doUser_Id :id}})
      }
    },
    mounted(){
