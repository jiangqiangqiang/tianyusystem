        ...
        <div class="ty-header-list3">
          <div class="ty-shaoxuan-content">
            ...
            <div class="ty-shaixuan-list1">
              ...
              <el-input placeholder="请输入用户姓名/昵称" class="searchBox" v-model="nickname"></el-input>
    ...
    <el-main><!-- 編輯彈窗頁面 catalogueDialog"-->
      ...
      <el-table :data="tableData" style="width: 100%">
        ...
        <el-table-column prop="status" label="账户启用状态">
          <template slot-scope="scope">
            <img src="../../assets/img/20180516162000.png" style="cursor: pointer" v-show="scope.row.status"
                 @click="ntn(scope)" alt="">
            <img src="../../assets/img/20180516161301.png" style="cursor: pointer" v-show="!scope.row.status"
                 @click="ntn(scope)" alt="">
          </template>
        </el-table-column>
