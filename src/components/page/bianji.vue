      ...
      <div class="ty-el-main-list1">
       ...
       <div class="ty-content">
         ...
         <div class="ty-content-div-list">
           <span>  &#12288&#12288昵称：</span><el-input v-model="nickName"></el-input>
           <span>  &#12288&#12288手机号码：</span><el-input v-model="mobile"></el-input>
         </div>
         <div class="ty-content-div-list">
           <span>  &#12288&#12288密码：</span><el-input v-model="pwd"></el-input>
         </div>
         <div    class="ty-content-div-list">
         ...
         <div class="ty-content-div-list">
           <span>  &#12288&#12288姓名：</span><el-input v-model="name"></el-input>
           <span>  &#12288&#12288性别：</span>
           <el-radio v-model="sexRadio" label="1">男</el-radio>
           <el-radio v-model="sexRadio" label="2">女</el-radio>
           <span>  &#12288&#12288民族：</span><el-input v-model="nationality"></el-input>
         </div>
         <div class="ty-content-div-list"  :model="form">
           <span>  &#12288&#12288年龄：</span><el-input v-model="age"></el-input>
...
<!--身份证号-->
         <div class="ty-content-div-list"  :model="form">
           <span>  &#12288&#12288身份证号：</span><el-input v-model="idCardNumber"></el-input>
         </div>
<!--身份证号-->
         <div class="ty-content-div-list"  :model="form">
         ...
         <div class="ty-content-div-list">
           <span>  &#12288&#12288第一联系人姓名：</span><el-input v-model="emergencyContact1"></el-input>
           <span>  &#12288&#12288联系方式：</span><el-input v-model="emergencyMobile1"></el-input>
         </div>
         <div class="ty-content-div-list">
           <span>  &#12288&#12288第二联系人姓名：</span><el-input v-model="emergencyContact2"></el-input>
           <span>  &#12288&#12288联系方式：</span><el-input v-model="emergencyMobile2"></el-input>
         </div>
         <p class="ty-p-one">病史</p>
         <div class="ty-content-div-list">
           <span>  &#12288&#12288药物及过敏史：</span><el-input v-model="allergyDiseaseHistory"></el-input>
           <span>  &#12288&#12288遗传病史：</span><el-input v-model="geneticDiseaseHistroy"></el-input>
         </div>
         <div class="ty-content-div-list">
           <span>  &#12288&#12288手术史：</span><el-input v-model="surgeryDiseaseHistory"></el-input>
         </div>
       </div>
      </div>
    </el-main>
      ...
      <el-table
        ...
        <el-table-column label="操作">
          <template slot-scope="scope">
            <el-button
              size="mini"
              @click="handleEditTable(scope.$index, scope.row.url)">下载</el-button>
            <el-button
              size="mini"
              type="danger"
              @click="handleDeleteTable(scope.$index, scope.row)">删除</el-button>
          </template>
        </el-table-column>
      </el-table>
        ...
        axios({
          ...
          if (res.data.code == 0){
            ...
            if (birthAddresss.length == 4){
              ...
              self.selectedOptions.push(birthAddresss[0]);
              self.selectedOptions.push(birthAddresss[1]);
              self.addDetail1=birthAddresss[2];
            }
            ...
            if (lifeAddress.length == 4){
              ...
              self.addDetail2=birthAddresss[3];
            }else{
              self.selectedOptions2.push(lifeAddress[0]);
              self.selectedOptions2.push(lifeAddress[1]);
              self.addDetail2=birthAddresss[2];
            }
