  ...
  <el-container class="catalogue">
    <el-header>
      ...
      <el-row :gutter="20">
        ...
        <el-col :span="2" :offset="3"><div class="grid-content bg-purple ty-catalogue-list1" @click="sublist">
          <span>全部商品<span style="color: red;margin-left: 10px">{{this.total}}</span></span>
        </div></el-col>
        <el-col :span="2"><div class="grid-content bg-purple ty-catalogue-list1" @click="puton">
          <span>已上架<span style="color: red;margin-left: 10px">{{this.putonCount}}</span></span>
        </div></el-col>
        <el-col :span="2"><div class="grid-content bg-purple ty-catalogue-list1" @click="putout">
          <span>未上架<span style="color: red;margin-left: 10px">{{this.putoffCount}}</span></span>
        </div></el-col>
    ...
    <el-main><!-- 編輯彈窗頁面 catalogueDialog"-->
      <el-table :data="tableData"  style="width: 100%">
        ...
        <el-table-column prop="price" label="标注单位"></el-table-column>
        <el-table-column prop="majorPath" label="商品主图片路径">
     ...
     <!--   <el-table-column prop="usedByFamily" label="家属"></el-table-column>
        ...
        <el-table-column prop="isPutOn" label="上架状态" :formatter="isstate"></el-table-column>
        <!--编辑-->
        <el-table-column label="操作上架状态"> <template slot-scope="scope">
          <!--<el-button>{{scope.row.freeze
              }}</el-button>-->
          <div @click="switchoverState(scope.row,scope.row.id)" type="text" size="small" v-if="scope.row.isPutOn"><img src="../../assets/1.png" alt=""></div>
          <div @click="switchoverState(scope.row,scope.row.id)" type="text" size="small" v-if="!scope.row.isPutOn"><img src="../../assets/2.png" alt=""></div>
        </template>
        </el-table-column>
        ...
        <el-table-column label="">
          <template slot-scope="scope">
            <el-button
              size="mini"
              type="danger"
              @click="editformdelet(scope.$index, scope.row.id)">删除</el-button>
          </template>
        </el-table-column>
      </el-table>
      <!--页数标签-->
