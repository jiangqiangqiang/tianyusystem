<template>
  <div class="TY-content">
        ...
        <el-form :model="ruleForm1" ref="ruleForm1" label-width="100px" class="demo-ruleForm">
          ...
          <el-form-item label="规格" prop="desc">
            <el-row v-for="(l,index) in standardsList" style="margin-bottom: 10px;">
              <el-button type="primary">{{l.data.name}}<i class="el-icon-edit el-icon--right" @click="eidtStandard(index)"></i><i class="el-icon-delete el-icon--right" @click="delStandard(index)"></i></el-button>
            </el-row>
    ...
    <el-dialog title="规格信息" :visible.sync="dialogTableVisible" :modal="false" :center="true" >
      ...
      <div class="ty-right-anniu">
        <el-button @click="standardSave">保存</el-button>
...
//        to:'',
        ...
        actionUrl:"http://api.tianyushangyi.com/file/upload?token="+localStorage.getItem('currentUser_token'),
        token:'',
        currentPage:1,
        currentSize:10,
        pageNum:0,
      ...
      sublist(){//编辑带id请求self.params.doUserId
        ...
        axios({
          ...
          if(res.data['code']=='0'){
            ...
            self.fileList2.push({url:this.dddd});
            ...
            self.table1.push(ob);//规格的id
            console.log(self.table1,'13233');
          }
        })
