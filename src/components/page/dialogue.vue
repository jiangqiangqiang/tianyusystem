  ...
  <el-container class="orderlist">
    ...
    <el-main><!-- 編輯彈窗頁面 catalogueDialog"-->
      <div class="ty-header-list22">
        ...
        <el-col :span="2"><div class="grid-content bg-purple ty-el-main-4" :class="typeFlag.today ? 'typeselect' : ''" @click="changeTypeGetList('today')">今天</div></el-col>
        <el-col :span="2"><div class="grid-content bg-purple ty-el-main-4" :class="typeFlag.lastweek ? 'typeselect' : ''" @click="changeTypeGetList('lastweek')">最近一周</div></el-col>
        <el-col :span="2"><div class="grid-content bg-purple ty-el-main-4" :class="typeFlag.lastmonth ? 'typeselect' : ''" @click="changeTypeGetList('lastmonth')">最近一个月</div></el-col>
        <el-col :span="2"><div class="grid-content bg-purple ty-el-main-4" :class="typeFlag.all ? 'typeselect' : ''" @click="changeTypeGetList('all')">全部</div></el-col>
      ...
      <div class="ty-serve">
        <div class="ty-serve-left">
          <div class="ty-serve-list" v-for="l in dialogueList" @click="getDialogueListDetail(l)">
            ...
            <div class="ty-time-p">
              <p>开始时间<span>{{l.start}}</span></p> <p>结束时间<span>{{l.end}} </span></p>
            </div>
          </div>
        </div>
    ...
    <el-footer class="ty-footer">
      ...
      <div class="ty-foot-rig">
        <div class="pages">
          <el-pagination @size-change="handleSizeChangeDetail" @current-change="handleCurrentChangeDetail" :current-page.sync="currentPageDetail" :page-sizes="[10, 20, 30, 40]" :page-size="10" background layout="sizes,prev, pager, next" :total="pageNumDetail">
          </el-pagination>
        </div>
      </div>
    </el-footer>
