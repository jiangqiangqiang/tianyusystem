        ...
        <el-table-column label="操作付款状态">
          <template slot-scope="scope">
            <el-button  v-show="scope.row.status == '未付款'"
              size="mini"
              type="primary"
              @click="handlecompilestate(scope.$index, scope.row.id,scope.row.status)">切换</el-button>
          </template>
        </el-table-column>
        <el-table-column label="操作">
          <template slot-scope="scope">
            <el-button
              size="mini"
              type="primary"
              @click="handlecompile(scope.$index, scope.row.id,scope.row.status)">查看详情订单</el-button>
          </template>
        </el-table-column>
      </el-table>
      <!--页数标签-->
